'use server';
/**
 * @fileOverview Extracts text from an image using Google Cloud Vision OCR and allows editing and refining the extracted text.
 *
...
const extractTextPrompt = ai.definePrompt({
  ...
  prompt: `You are an OCR expert. Extract the text from the following image of handwritten notes:
